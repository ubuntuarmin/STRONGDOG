function createUnityInstance(t, n, c) {
  ...
  return l.SystemInfo = function() {
    ...
    l.SystemInfo.hasWebGL ? l.SystemInfo.hasWasm ? (1 == l.SystemInfo.hasWebGL && l.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'), l.startupErrorHandler = t, c(0), l.postRun.push(function() {
